...
model StratifiedTESTest
  ...
  Components.Storage.Stratified1DStorage stratified1DStorage(D = 1.7, N = 5, T_ext = 298.15, T_start = 338.15, h = 5)  annotation(
...
equation
  connect(massflow.y, idealMassFlowSource.M) annotation(
    Line(points = {{-91, 58}, {-78, 58}}, color = {0, 0, 127}));
  ...
  connect(constant2.y, idealMassFlowSource1.M) annotation(
    Line(points = {{-91, 26}, {-78, 26}}, color = {0, 0, 127}));
